...
namespace Pulumi.Nobl9
{
    ...
    public partial class AlertMethodJira : global::Pulumi.CustomResource
    {
        ...
        public AlertMethodJira(string name, AlertMethodJiraArgs args, CustomResourceOptions? options = null)
            : base("nobl9:index/alertMethodJira:AlertMethodJira", name, args ?? new AlertMethodJiraArgs(), MakeResourceOptions(options, ""))
        {
        }

        private AlertMethodJira(string name, Input<string> id, AlertMethodJiraState? state = null, CustomResourceOptions? options = null)
            : base("nobl9:index/alertMethodJira:AlertMethodJira", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static AlertMethodJira Get(string name, Input<string> id, AlertMethodJiraState? state = null, CustomResourceOptions? options = null)
        {
            return new AlertMethodJira(name, id, state, options);
        }
    }
    ...
    public sealed class AlertMethodJiraArgs : global::Pulumi.ResourceArgs
    {
        ...
        public AlertMethodJiraArgs()
        {
        }
        public static new AlertMethodJiraArgs Empty => new AlertMethodJiraArgs();
    }
    ...
    public sealed class AlertMethodJiraState : global::Pulumi.ResourceArgs
    {
        ...
        public AlertMethodJiraState()
        {
        }
        public static new AlertMethodJiraState Empty => new AlertMethodJiraState();
    }
}
