...
namespace Pulumi.Nobl9
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/piclemx/pulumi-noble9/releases/";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Nobl9.version.txt");
    ...
    internal sealed class Nobl9ResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public Nobl9ResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
