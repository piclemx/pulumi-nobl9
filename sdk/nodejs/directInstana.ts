 ...
 */
export class DirectInstana extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DirectInstanaState, opts?: pulumi.CustomResourceOptions): DirectInstana {
        return new DirectInstana(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nobl9:index/directInstana:DirectInstana';

    /**
     * Returns true if the given object is an instance of DirectInstana.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DirectInstana {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DirectInstana.__pulumiType;
    }
     ...
     */
    public readonly queryDelay!: pulumi.Output<outputs.DirectInstanaQueryDelay | undefined>;
    /**
     ...
     */
    constructor(name: string, args: DirectInstanaArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DirectInstanaArgs | DirectInstanaState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DirectInstanaState | undefined;
            ...
            const args = argsOrState as DirectInstanaArgs | undefined;
        ...
        super(DirectInstana.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DirectInstanaState {
    /**
     * [required] | Instana API Token.
     */
     ...
     * [Query delay configuration documentation](https://docs.nobl9.com/Features/query-delay). Computed if not provided.
     */
    queryDelay?: pulumi.Input<inputs.DirectInstanaQueryDelay>;
    /**
     * Source of Metrics and/or Services.
     */
 ...
 */
export interface DirectInstanaArgs {
    /**
     * [required] | Instana API Token.
     */
    apiToken?: pulumi.Input<string>;
