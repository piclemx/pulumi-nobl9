...
class DirectThousandeyes(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["oauth_bearer_token"] = None if oauth_bearer_token is None else pulumi.Output.secret(oauth_bearer_token)
        ...
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["oauthBearerToken"])
    ...
    @property
    @pulumi.getter(name="queryDelay")
    def query_delay(self) -> pulumi.Output['outputs.DirectThousandeyesQueryDelay']:
        """
        [Query delay configuration documentation](https://docs.nobl9.com/Features/query-delay). Computed if not provided.
        """
        return pulumi.get(self, "query_delay")
