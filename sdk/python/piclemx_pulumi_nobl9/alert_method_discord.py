...
__all__ = ['AlertMethodDiscordArgs', 'AlertMethodDiscord']

@pulumi.input_type
class AlertMethodDiscordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] url: Discord webhook endpoint URL. Refer to [Intro to webhooks | Discord documentation](https://support.discord.com/hc/en-us/articles/228383668-Intro-to-Webhooks) for more details.
        """
...
@pulumi.input_type
class _AlertMethodDiscordState:
    def __init__(__self__, *,
                 description: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
...
class AlertMethodDiscord(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 __props__=None):
        """
        Create a AlertMethodDiscord resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: AlertMethodDiscordArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a AlertMethodDiscord resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param AlertMethodDiscordArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AlertMethodDiscordArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AlertMethodDiscordArgs.__new__(AlertMethodDiscordArgs)
        ...
        super(AlertMethodDiscord, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            project: Optional[pulumi.Input[str]] = None,
            url: Optional[pulumi.Input[str]] = None) -> 'AlertMethodDiscord':
        """
        ...
        __props__ = _AlertMethodDiscordState.__new__(_AlertMethodDiscordState)
        ...
        return AlertMethodDiscord(resource_name, opts=opts, __props__=__props__)
