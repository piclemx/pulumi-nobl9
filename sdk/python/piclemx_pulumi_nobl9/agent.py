...
class AgentArgs:
    def __init__(__self__, *,
                 ...
                 azure_monitor_config: Optional[pulumi.Input['AgentAzureMonitorConfigArgs']] = None,
                 ...
                 historical_data_retrieval: Optional[pulumi.Input['AgentHistoricalDataRetrievalArgs']] = None,
                 honeycomb_config: Optional[pulumi.Input['AgentHoneycombConfigArgs']] = None,
        ...
        :param pulumi.Input['AgentAzureMonitorConfigArgs'] azure_monitor_config: [Configuration documentation](https://docs.nobl9.com/Sources/azure-monitor#azure-monitor-agent)
        ...
        :param pulumi.Input['AgentHistoricalDataRetrievalArgs'] historical_data_retrieval: [Replay configuration documentation](https://docs.nobl9.com/replay)
        :param pulumi.Input['AgentHoneycombConfigArgs'] honeycomb_config: [Configuration documentation](https://docs.nobl9.com/Sources/honeycomb#hc-agent)
        ...
        if azure_monitor_config is not None:
            pulumi.set(__self__, "azure_monitor_config", azure_monitor_config)
        ...
        if honeycomb_config is not None:
            pulumi.set(__self__, "honeycomb_config", honeycomb_config)
    ...
    @property
    @pulumi.getter(name="azureMonitorConfig")
    def azure_monitor_config(self) -> Optional[pulumi.Input['AgentAzureMonitorConfigArgs']]:
        """
        [Configuration documentation](https://docs.nobl9.com/Sources/azure-monitor#azure-monitor-agent)
        """
        return pulumi.get(self, "azure_monitor_config")

    @azure_monitor_config.setter
    def azure_monitor_config(self, value: Optional[pulumi.Input['AgentAzureMonitorConfigArgs']]):
        pulumi.set(self, "azure_monitor_config", value)
    ...
    def historical_data_retrieval(self) -> Optional[pulumi.Input['AgentHistoricalDataRetrievalArgs']]:
        """
    ...
    def historical_data_retrieval(self, value: Optional[pulumi.Input['AgentHistoricalDataRetrievalArgs']]):
        pulumi.set(self, "historical_data_retrieval", value)

    @property
    @pulumi.getter(name="honeycombConfig")
    def honeycomb_config(self) -> Optional[pulumi.Input['AgentHoneycombConfigArgs']]:
        """
        [Configuration documentation](https://docs.nobl9.com/Sources/honeycomb#hc-agent)
        """
        return pulumi.get(self, "honeycomb_config")

    @honeycomb_config.setter
    def honeycomb_config(self, value: Optional[pulumi.Input['AgentHoneycombConfigArgs']]):
        pulumi.set(self, "honeycomb_config", value)
...
class Agent(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 azure_monitor_config: Optional[pulumi.Input[pulumi.InputType['AgentAzureMonitorConfigArgs']]] = None,
                 ...
                 historical_data_retrieval: Optional[pulumi.Input[pulumi.InputType['AgentHistoricalDataRetrievalArgs']]] = None,
                 honeycomb_config: Optional[pulumi.Input[pulumi.InputType['AgentHoneycombConfigArgs']]] = None,
        ...
        :param pulumi.Input[pulumi.InputType['AgentAzureMonitorConfigArgs']] azure_monitor_config: [Configuration documentation](https://docs.nobl9.com/Sources/azure-monitor#azure-monitor-agent)
        ...
        :param pulumi.Input[pulumi.InputType['AgentHistoricalDataRetrievalArgs']] historical_data_retrieval: [Replay configuration documentation](https://docs.nobl9.com/replay)
        :param pulumi.Input[pulumi.InputType['AgentHoneycombConfigArgs']] honeycomb_config: [Configuration documentation](https://docs.nobl9.com/Sources/honeycomb#hc-agent)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["azure_monitor_config"] = azure_monitor_config
            ...
            __props__.__dict__["honeycomb_config"] = honeycomb_config
    ...
    @property
    @pulumi.getter(name="azureMonitorConfig")
    def azure_monitor_config(self) -> pulumi.Output[Optional['outputs.AgentAzureMonitorConfig']]:
        """
        [Configuration documentation](https://docs.nobl9.com/Sources/azure-monitor#azure-monitor-agent)
        """
        return pulumi.get(self, "azure_monitor_config")
    ...
    @property
    @pulumi.getter(name="historicalDataRetrieval")
    def historical_data_retrieval(self) -> pulumi.Output['outputs.AgentHistoricalDataRetrieval']:
        """
        [Replay configuration documentation](https://docs.nobl9.com/replay)
        """
        return pulumi.get(self, "historical_data_retrieval")
    ...
    @property
    @pulumi.getter(name="honeycombConfig")
    def honeycomb_config(self) -> pulumi.Output[Optional['outputs.AgentHoneycombConfig']]:
        """
        [Configuration documentation](https://docs.nobl9.com/Sources/honeycomb#hc-agent)
        """
        return pulumi.get(self, "honeycomb_config")
    ...
    @property
    @pulumi.getter(name="queryDelay")
    def query_delay(self) -> pulumi.Output['outputs.AgentQueryDelay']:
        """
        [Query delay configuration documentation](https://docs.nobl9.com/Features/query-delay). Computed if not provided.
        """
        return pulumi.get(self, "query_delay")
