...
__all__ = ['DirectDatadogArgs', 'DirectDatadog']

@pulumi.input_type
class DirectDatadogArgs:
    def __init__(__self__, *,
                 ...
                 historical_data_retrieval: Optional[pulumi.Input['DirectDatadogHistoricalDataRetrievalArgs']] = None,
                 log_collection_enabled: Optional[pulumi.Input[bool]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 query_delay: Optional[pulumi.Input['DirectDatadogQueryDelayArgs']] = None,
        ...
        :param pulumi.Input[str] api_key: [required] | Datadog API Key.
        :param pulumi.Input[str] application_key: [required] | Datadog Application Key.
        ...
        :param pulumi.Input['DirectDatadogHistoricalDataRetrievalArgs'] historical_data_retrieval: [Replay configuration documentation](https://docs.nobl9.com/replay)
        ...
        :param pulumi.Input['DirectDatadogQueryDelayArgs'] query_delay: [Query delay configuration documentation](https://docs.nobl9.com/Features/query-delay). Computed if not provided.
    ...
    def historical_data_retrieval(self) -> Optional[pulumi.Input['DirectDatadogHistoricalDataRetrievalArgs']]:
        """
    ...
    def historical_data_retrieval(self, value: Optional[pulumi.Input['DirectDatadogHistoricalDataRetrievalArgs']]):
    ...
    def query_delay(self) -> Optional[pulumi.Input['DirectDatadogQueryDelayArgs']]:
        """
    ...
    @query_delay.setter
    def query_delay(self, value: Optional[pulumi.Input['DirectDatadogQueryDelayArgs']]):
...
class DirectDatadog(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 historical_data_retrieval: Optional[pulumi.Input[pulumi.InputType['DirectDatadogHistoricalDataRetrievalArgs']]] = None,
                 log_collection_enabled: Optional[pulumi.Input[bool]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 query_delay: Optional[pulumi.Input[pulumi.InputType['DirectDatadogQueryDelayArgs']]] = None,
                 release_channel: Optional[pulumi.Input[str]] = None,
                 site: Optional[pulumi.Input[str]] = None,
                 source_ofs: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[str] description: Optional description of the resource. Here, you can add details about who is responsible for the integration (team/owner) or the purpose of creating it.
        :param pulumi.Input[str] display_name: User-friendly display name of the resource.
        :param pulumi.Input[pulumi.InputType['DirectDatadogHistoricalDataRetrievalArgs']] historical_data_retrieval: [Replay configuration documentation](https://docs.nobl9.com/replay)
        :param pulumi.Input[bool] log_collection_enabled: [Logs documentation](https://docs.nobl9.com/Features/SLO_troubleshooting/event-logs)
        :param pulumi.Input[str] name: Unique name of the resource, must conform to the naming convention from [DNS RFC1123](https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names).
        :param pulumi.Input[str] project: Name of the Nobl9 project the resource sits in, must conform to the naming convention from [DNS RFC1123](https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names).
        :param pulumi.Input[pulumi.InputType['DirectDatadogQueryDelayArgs']] query_delay: [Query delay configuration documentation](https://docs.nobl9.com/Features/query-delay). Computed if not provided.
        :param pulumi.Input[str] release_channel: Release channel of the created datasource [stable/beta]
        :param pulumi.Input[str] site: `com` or `eu`, Datadog SaaS instance, which corresponds to one of Datadog's two locations (https://www.datadoghq.com/ in the U.S. or https://datadoghq.eu/ in the European Union).
        :param pulumi.Input[Sequence[pulumi.Input[str]]] source_ofs: This value indicated whether the field was a source of metrics and/or services. 'source_of' is deprecated and not used anywhere; however, it's kept for backward compatibility.
        """
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DirectDatadogArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DirectDatadogArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DirectDatadogArgs.__new__(DirectDatadogArgs)
        ...
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["apiKey", "applicationKey"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(DirectDatadog, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            site: Optional[pulumi.Input[str]] = None,
            source_ofs: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            status: Optional[pulumi.Input[str]] = None) -> 'DirectDatadog':
        """
        ...
        __props__ = _DirectDatadogState.__new__(_DirectDatadogState)
        ...
        return DirectDatadog(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="historicalDataRetrieval")
    def historical_data_retrieval(self) -> pulumi.Output['outputs.DirectDatadogHistoricalDataRetrieval']:
        """
        [Replay configuration documentation](https://docs.nobl9.com/replay)
        """
        return pulumi.get(self, "historical_data_retrieval")
    ...
    @property
    @pulumi.getter(name="queryDelay")
    def query_delay(self) -> pulumi.Output['outputs.DirectDatadogQueryDelay']:
        """
        [Query delay configuration documentation](https://docs.nobl9.com/Features/query-delay). Computed if not provided.
        """
        return pulumi.get(self, "query_delay")
