...
__all__ = ['DirectSplunkArgs', 'DirectSplunk']

@pulumi.input_type
class DirectSplunkArgs:
    def __init__(__self__, *,
                 ...
                 historical_data_retrieval: Optional[pulumi.Input['DirectSplunkHistoricalDataRetrievalArgs']] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 query_delay: Optional[pulumi.Input['DirectSplunkQueryDelayArgs']] = None):
        """
        ...
        :param pulumi.Input['DirectSplunkHistoricalDataRetrievalArgs'] historical_data_retrieval: [Replay configuration documentation](https://docs.nobl9.com/replay)
        ...
        :param pulumi.Input['DirectSplunkQueryDelayArgs'] query_delay: [Query delay configuration documentation](https://docs.nobl9.com/Features/query-delay). Computed if not provided.
        """
    ...
    def historical_data_retrieval(self) -> Optional[pulumi.Input['DirectSplunkHistoricalDataRetrievalArgs']]:
        """
    ...
    def historical_data_retrieval(self, value: Optional[pulumi.Input['DirectSplunkHistoricalDataRetrievalArgs']]):
    ...
    def query_delay(self) -> Optional[pulumi.Input['DirectSplunkQueryDelayArgs']]:
        """
    ...
    @query_delay.setter
    def query_delay(self, value: Optional[pulumi.Input['DirectSplunkQueryDelayArgs']]):
        pulumi.set(self, "query_delay", value)


@pulumi.input_type
class _DirectSplunkState:
    def __init__(__self__, *,
                 access_token: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
...
class DirectSplunk(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 historical_data_retrieval: Optional[pulumi.Input[pulumi.InputType['DirectSplunkHistoricalDataRetrievalArgs']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 project: Optional[pulumi.Input[str]] = None,
                 query_delay: Optional[pulumi.Input[pulumi.InputType['DirectSplunkQueryDelayArgs']]] = None,
                 source_ofs: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 url: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] description: Optional description of the resource. Here, you can add details about who is responsible for the integration (team/owner) or the purpose of creating it.
        :param pulumi.Input[str] display_name: User-friendly display name of the resource.
        :param pulumi.Input[pulumi.InputType['DirectSplunkHistoricalDataRetrievalArgs']] historical_data_retrieval: [Replay configuration documentation](https://docs.nobl9.com/replay)
        :param pulumi.Input[str] name: Unique name of the resource, must conform to the naming convention from [DNS RFC1123](https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names).
        :param pulumi.Input[str] project: Name of the Nobl9 project the resource sits in, must conform to the naming convention from [DNS RFC1123](https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names).
        :param pulumi.Input[pulumi.InputType['DirectSplunkQueryDelayArgs']] query_delay: [Query delay configuration documentation](https://docs.nobl9.com/Features/query-delay). Computed if not provided.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] source_ofs: Source of Metrics and/or Services.
        :param pulumi.Input[str] url: Base API URL to the Splunk Search app.
        """
        ...
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DirectSplunkArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DirectSplunkArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DirectSplunkArgs.__new__(DirectSplunkArgs)
        ...
        super(DirectSplunk, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            source_ofs: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            status: Optional[pulumi.Input[str]] = None,
            url: Optional[pulumi.Input[str]] = None) -> 'DirectSplunk':
        """
        ...
        __props__ = _DirectSplunkState.__new__(_DirectSplunkState)
        ...
        __props__.__dict__["url"] = url
        return DirectSplunk(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="historicalDataRetrieval")
    def historical_data_retrieval(self) -> pulumi.Output[Optional['outputs.DirectSplunkHistoricalDataRetrieval']]:
        """
        [Replay configuration documentation](https://docs.nobl9.com/replay)
        """
        return pulumi.get(self, "historical_data_retrieval")
    ...
    @property
    @pulumi.getter(name="queryDelay")
    def query_delay(self) -> pulumi.Output[Optional['outputs.DirectSplunkQueryDelay']]:
        """
        [Query delay configuration documentation](https://docs.nobl9.com/Features/query-delay). Computed if not provided.
        """
        return pulumi.get(self, "query_delay")
