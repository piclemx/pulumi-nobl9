...
class RoleBindingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] role_ref: Role name; the role that you want the user to assume.
        :param pulumi.Input[str] user: Okta User ID that can be retrieved from the Nobl9 UI (**Settings** > **Users**).
        ...
        :param pulumi.Input[str] project_ref: Project name, the project in which we want the user to assume the specified role. When `project_ref` is empty, `role_ref` must contain an Organization Role.
        """
